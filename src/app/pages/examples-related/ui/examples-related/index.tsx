...
export const UiExampleComponentsPage: React.FC = () => {
	return <>
		...
		<p>They are localed in <Src
			src={'src/engine/ui-components/examples-related'}
		...
		<SyntaxHighlight
			title={'src/engine/ui-components/components.less'}
			language={'less'}
		...
		<Src src={'src/engine/ui-components/examples-related/lipsum.tsx'}/>
		<p>
		...
		<Src src={'src/engine/ui-components/examples-related/syntax-highlight.tsx'}/>
		<p>
		...
		<ul>
			<li><Src inline src={'src/engine/ui-components/examples-related/prism.css'}/></li>
			<li><Src inline src={'src/engine/ui-components/examples-related/prism.js'}/></li>
		</ul>

		<ExampleSyntaxHighlight/>

		<Title level={3} nav={'example_tabs'}>Example tabs</Title>
		<Src src={'src/engine/ui-components/examples-related/syntax-example-tabs.tsx'}/>
		<p>
