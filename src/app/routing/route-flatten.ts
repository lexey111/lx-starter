	...
	routes.forEach(route => {
		if (!route.routes || route.routes.length === 0) {
			result.push({
				...
				onlyWhenLoggedIn: route.onlyWhenLoggedIn,
				onlyWhenLoggedOut: route.onlyWhenLoggedOut,
				spinnerDuringLogin: route.spinnerDuringLogin,
				noBreadcrumbs: route.noBreadcrumbs,
